...
type UserRepository interface {
	...
	FindAllForPagging(tx *gorm.DB, userId uuid.UUID, role string, pageSize int, offset int, order string, sortBy string, users *[]entity.User) (int64, error)
...
func (repository *UserRepositoryImpl) FindAllForPagging(tx *gorm.DB, userId uuid.UUID, role string, pageSize int, offset int, order string, sortBy string, users *[]entity.User) (int64, error) {
	var total int64
	query := tx.Model(&entity.User{})
